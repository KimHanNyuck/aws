    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <div class="card">
        <form action="myissueEditOk.do" method="POST" enctype="multipart/form-data" onsubmit="return checkDate();">
